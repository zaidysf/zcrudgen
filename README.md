...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/zcrudgen.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/zcrudgen)
...
```bash
php artisan vendor:publish --tag="zcrudgen-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="zcrudgen-config"
```
...
```bash
php artisan vendor:publish --tag="zcrudgen-views"
```

## Usage

```php
$zcrudgen = new Zaid Yasyaf\Zcrudgen();
echo $zcrudgen->echoPhrase('Hello, Zaid Yasyaf!');
```
